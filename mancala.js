...
(function(){
	...
	*/
	function readyUp(){
		...
		let url = "http://gavin-mancala2.herokuapp.com:" + process.env.PORT + "?readyUp=1&username=" + username + "&playing=0";
		fetch(url)
			.then(checkStatus)
	...
	*/
	function movePiece(){
		if (currCircle > 0 && currCircle < 7 && gameData.playerNo == 1 &&
				...
				&& gameData.myTurn && gameData.currBoard[currCircle] != 0){
			let url = "http://gavin-mancala2.herokuapp.com:" + process.env.PORT + "?readyUp=0&playing=1&boardId=" +
	...
	*/
	function getGameData(){
		let url = "http://gavin-mancala2.herokuapp.com:" + process.env.PORT + "?readyUp=0&playing=2&boardId=" + gameData.boardNo;
		fetch(url)
			.then(checkStatus)
			.then(function(responseText){
	...
	*/
	function getReadiedPlayers(){
		let url = "http://gavin-mancala2.herokuapp.com:" + process.env.PORT + "?getReadyPlayers=1";
		fetch(url)
			.then(checkStatus)
			.then(function(responseText){
